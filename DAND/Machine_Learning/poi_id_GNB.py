...
CLF_PICKLE_FILENAME = "./GNB/my_classifier.pkl"
DATASET_PICKLE_FILENAME = "./GNB/my_dataset.pkl"
FEATURE_LIST_FILENAME = "./GNB/my_feature_list.pkl"
...
features_list = ['poi', 'salary', 'deferral_payments', 'total_payments', 'bonus',
                 ...
                 'sal_pkg_pct', 'pay_stock_ratio', 'ratio_to_msg', 'ratio_from_msg', 'to_messages', 'from_poi_to_this_person',
...
param_grid = {
            ...
            "reduce__n_components": range(1, 10),
            }
...
grid_srch = GridSearchCV(pipeline, param_grid=param_grid, scoring="f1", cv=sss)
grid_srch.fit(features_train, labels_train)

print "Parameters found:"
print grid_srch.best_params_
print " "
print "Classifier Model found:"
print grid_srch.best_estimator_

clf = grid_srch.best_estimator_

prediction = clf.best_estimator_.predict(features_test)
